<section class="section-intro az-container mt-16 xl:mt-64 xl:mb-52">
	<div class="az-container-grid items-center">
		<div class="col-span-1 md:col-span-8 xl:col-span-4 xl:col-start-3">
			<?php
			$image = get_field( 'activities_archive_intro_image', 'options' );
			if ( $image ) :
		...
		<div class="col-span-1 md:col-span-8 xl:col-span-3 xl:col-start-8 text-center xl:text-left">
			<h1 class="title-xl mb-12 xl:mb-24 md:max-w-xl xl:max-w-none mx-auto"><?php the_field( 'activities_archive_intro_title', 'options' ); ?></h1>
			<p class="text-body mb-24 xl:mb-0 md:max-w-lg xl:max-w-none mx-auto"><?php the_field( 'activities_archive_intro_description', 'options' ); ?></p>
		</div>
	</div>
</section>