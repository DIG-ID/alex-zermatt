		...
		while ( $spiellelounge_query->have_posts() ) :
			...
			<div class="infrastructure-content az-container xl:pt-40 pb-20 md:pb-24 xl:pb-36 overflow-hidden">
				<div class="az-container-grid">
					<div class="col-span-1 md:col-span-8 xl:col-span-3 xl:col-start-3 order-1 xl:order-1">
					...
					<div class="col-span-1 md:col-span-8 xl:col-span-8 xl:col-start-6 order-2 xl:order-2 text-center">
