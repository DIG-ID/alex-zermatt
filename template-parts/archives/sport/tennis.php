<section class="section-tennis az-container mb-28 xl:mb-52">
	<div class="az-container-grid">
		<div class="col-span-1 md:col-span-8 xl:col-span-4 xl:col-start-3">
			...
			if ( $img ) :
				echo wp_get_attachment_image( $img, 'full', false, array( 'class' => 'w-full object-cover mb-12 xl:mb-0' ) );
			endif;
			?>
		</div>
		<div class="col-span-1 md:col-span-8 xl:col-span-3 xl:col-start-8">
			<div class="grid grid-cols-1 md:grid-cols-8 xl:grid-cols-3 md:gap-4 xl:gap-9">
				...
				<div class="col-span-1 md:col-span-4 xl:col-span-3">
					<p class="body-text mb-12 md:mb-14 xl:mb-16"><?php the_field( 'sport_archive_tennis_description', 'options' ); ?></p>
				</div>
			</div>
			<?php
