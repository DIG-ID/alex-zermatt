	...
	<div class="grid grid-cols-1 md:grid-cols-8 xl:grid-cols-10">
		<div class="col-span-1 md:col-span-8 xl:col-span-3">
			<div class="room-details fade-content">
				...
				<p class="text-body !font-bold !text-xl mb-7 mt-9 hidden 2xl:block"><?php the_field( 'overview_subtitle' ); ?></p>
				<p class="text-body max-w-[450px] hidden 2xl:block"><?php the_field( 'overview_description' ); ?></p>
			</div>
		</div>
