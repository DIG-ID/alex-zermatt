<section class="section-musuem .az-container border-b border-b-blue">
	...
	?>
	<div class="w-full flex items-center justify-center py-44" style="background: linear-gradient(to top, rgba(0, 40, 80, 0.9), rgba(0, 40, 80, 0.9) ), url('<?php echo esc_url( wp_get_attachment_image_url( $museum_bg, 'full' ) ); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;">
		<h2 class="font-serif font-light text-[52px] text-gold uppercase tracking-[2.6px]"><?php the_field( 'museum_title', 'options' ); ?></h2>
	</div>
	<div class="az-container-grid py-24">
		<div class="col-span-4 col-start-3">
			<p class="body-text"><?php the_field( 'museum_text_box_left', 'options' ); ?></p>
		</div>
