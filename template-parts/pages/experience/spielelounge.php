<section class="section-sport az-container mb-28 xl:mb-52">
	<div class="az-container-grid items-center">
		<div class="col-span-1 md:col-span-8 xl:col-span-4 xl:col-start-3">
			...
			<?php
			$stay_img_lg = get_field( 'spielelounge_image' );
			if ( $stay_img_lg ) :
		...
		<div class="col-span-1 md:col-span-8 xl:col-span-3 xl:col-start-8">
			<div class="grid grid-cols-1 md:grid-cols-8 xl:grid-cols-3 md:gap-4 xl:gap-9">
				<div class="col-span-1 md:col-span-4 xl:col-span-3">
					<h3 class="title-xl mb-6 md:mb-0 xl:mb-16 xl:mt-48"><?php the_field( 'spielelounge_title' ); ?></h3>
				</div>
				<div class="col-span-1 md:col-span-4 xl:col-span-3">
					<p class="text-body mb-12 md:mb-14 xl:mb-16"><?php the_field( 'spielelounge_description' ); ?></p>
				</div>
			</div>
			<?php
			$stay_link = get_field( 'spielelounge_link' );
			if ( $stay_link ) :
