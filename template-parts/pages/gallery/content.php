			...
			if ( have_rows( 'galleries' ) ) :
				while ( have_rows( 'galleries' ) ) :
					...
					if ( $gallery ) :
						$count = 0;
						?>
						<div class="gallery-<?php echo esc_attr( strtolower( $gallery_title ) ); ?>-container grid grid-cols-1 md:grid-cols-8 xl:grid-cols-10 md:gap-x-4 xl:gap-x-9 items-end mb-32">
							<?php
