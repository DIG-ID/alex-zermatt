<section class="section-enjoy az-container mb-28 xl:mb-72">
	<div class="az-container-grid xl:items-end">
		<div class="col-span-1 md:col-span-8 xl:col-span-4 xl:col-start-3">
			...
			if ( $stay_img_lg ) :
				echo wp_get_attachment_image( $stay_img_lg, 'full', false, array( 'class' => 'w-full object-cover mb-12 xl:mb-24 h-[377px] md:h-[800px] img-xl' ) );
			endif;
			?>
		</div>
		<div class="col-span-1 md:col-span-8 xl:col-span-3 xl:col-start-8">
			...
			if ( $stay_img_sm ) :
				echo wp_get_attachment_image( $stay_img_sm, 'full', false, array( 'class' => 'w-full aspect-square object-cover mb-12 xl:mb-24 hidden invisible xl:block xl:visible img-sm' ) );
			endif;
			?>
