<section id="section-rooms" class="section-rooms az-container overflow-hidden">
	<div class="az-container-grid">
		...
		<div class="col-span-1 md:col-span-4 xl:col-span-3 col-start-1 md:col-start-5 xl:col-start-8 pb-2">
			...
			<span class="block text-right xl:text-left mr-7 md:mr-16 xl:mr-0"><a class="btn btn--arrow-right" href="<?php the_field( 'section_rooms_cta_page' ); ?>"><?php echo esc_html_e( 'Zimmer & Suiten', 'alexzermatt' ) ?></a></span>
		</div>
    </div>
</section>