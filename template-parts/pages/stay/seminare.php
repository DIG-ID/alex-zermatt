<section id="section-seminare" class="section-seminare overflow-hidden az-container md:pt-24 xl:pt-28 pb-24 xl:pb-64">
	<div class="az-container-grid">
		...
		<div class="col-span-1 md:col-span-4 xl:col-span-3 col-start-1 md:col-start-5 xl:col-start-8">
			...
			<span class="btn-wrapper block text-right xl:text-left mr-16 xl:mr-0"><a class="btn btn--arrow-right" href="<?php the_field( 'section_seminare_cta_page' ); ?>"><?php echo esc_html_e( 'Saminarräume', 'alexzermatt' ) ?></a></span>
		</div>
    </div>
</section>